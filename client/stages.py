from world import Stage, Door, Room, Furniture, Layer
...
def genFS(self):
    ...
    stage.addPass(15,4)
    stage.addPass(15,7)
    stage.set(3,7,Door(type='h',stage=self))
    stage.set(18,7,Door(type='h',closed=True,stage=self))
    stage.set(12,9,Door(type='h',closed=True,locked=True,stage=self))
    rooms=[]
    ...
    comod=Furniture(2,2,stage=self)
