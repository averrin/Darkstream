...
QTITLES={\
		'Unique':[{'name':'Ancient','color':'yellow'},{'name':'Perfect','color':'cyanB'},{'name':'Sacred','color':'yellowB'}],\
		'Rare':[{'name':'Great','color':'greenB'},{'name':'Superior','color':'magentaB'}],\
		'Common':[{'name':'Wearied','color':'greyB'},{'name':'Common','color':'None'}]\
		}
